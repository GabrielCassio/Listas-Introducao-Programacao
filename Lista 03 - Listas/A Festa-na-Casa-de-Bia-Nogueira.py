...
if (tutorasOn or lenGuestList == 0):
    ...
    if (pautasOn == True):
        ...
        for i in range(lenGuestList):
            ...
            if (pautas[i] == "Medo de ficar musculosa demais por causa da academia"):
                print(f"AMIGA, ouça: tem nem o P do PERIGO de você ficar grandona sem querer. Não se preocupe!")
            elif (pautas[i] == "O cara que eu gosto não me quer, mas eu continuo insistindo. Acha que eu consigo algo?"):
                print(f"Claro que consegue, amiga! Consegue virar uma palhaça, consegue perder a autoestima... Consegue várias coisas :)")
            elif (pautas[i] == "Meu chefe só me dá um dia de folga, mas eu precisava de dois."):
            ...
            elif(pautas[i] == "Pessoas que adoram se fazer de coitadinhas"):
            ...
            elif(pautas[i] == "Essa história de que homem sofre calado"):
